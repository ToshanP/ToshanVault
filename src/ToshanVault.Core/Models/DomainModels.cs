...
public sealed class MintFortnightActual
{
    public DateOnly FortnightDate { get; set; }
    public double ActualOz { get; set; }
    public double ActualContribution { get; set; }
}
...
public sealed class Insurance
{
    ...
    public long? VaultEntryId { get; set; }
    /// <summary>Free-form notes (RTF or plain text), independent from the
    /// encrypted credential notes. Opened via the notes popup window.</summary>
    public string? Notes { get; set; }
